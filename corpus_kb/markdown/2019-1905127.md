...
![](images/7e91ca36168f2879e401b121df880c86db0a560e40913903d69516737d2324a8.jpg)
...
```mermaid
graph TD
  A["Digital currency system"] --> B["Commercial Bank"]
  A --> C["Risk management"]
  A --> D["Monetary policy"]
  A --> E["Regional economic difference"]
  A --> F["Individual"]
  F --> G["Fisher's equation"]
  F --> H["Keynesian theory of monetary demand"]
  F --> I["DMP"]
  F --> J["Search and matching model"]
  F --> K["Stability evaluation"]
  F --> L["Equilibrium analysis"]
  A --> M["State"]
  M --> N["Control measure: Tax rate"]
  M --> O["Supervision cost and black market"]
  M --> P["Long-term income optimization"]
  A --> Q["International"]
  Q --> R["Optimal currency area"]
  Q --> S["Profit margin Model based on Exchange rate"]
  A --> T["Capital centralization"]
  A --> U["Disappearance of the medium of exchange"]
  A --> V["A decline in financing costs"]
  A --> W["General currency's problem"]
```
</details>
...
![](images/4387d1e74a5899955bcc1b95c83d40a2616ff50af56f4331924935545d42cff1.jpg)
...
```mermaid
graph TD
  A["Exchange of goods"] --> B["Seller 1-f-d"]
  B --> C["Buyer f∈ (0, 1)"]
  B --> D["Buyer d∈ (0, 1)"]
  B --> E["P(f-o)"]
  B --> F["P(o-f)"]
...
![](images/7bd5b0a323c1a37f2a463b08638445131f4e722acc71b62309b91936a509fe88.jpg)
...
![](images/3efe43fee88609de1c18234a937f8050766b1dff0e86cb628dd27a82c2a24087.jpg)
...
![](images/1518308b54a2ef8eb004b37174b7101897c1e09bd02217429ee7de3ad737bf26.jpg)
...
![](images/f002485e74ce3d3c54b206599e15e277a3e9ad343536e0efe7ff8c6bf034b4cf.jpg)
